...
description: "Wrap up the current session: verify acceptance, follow repository delivery rules, archive only completed tasks, and record progress in the local journal. Use when done coding and ready to end the session."
---
