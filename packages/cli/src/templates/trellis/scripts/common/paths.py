...
Provides:
    ...
    get_workspace_dir      - Get local workspace directory
...
def get_workspace_dir(repo_root: Path | None = None) -> Path:
    """Return this worktree's personal journal directory."""
    return (repo_root or get_repo_root()) / DIR_WORKFLOW / DIR_WORKSPACE
